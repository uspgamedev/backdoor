...
return {
  ...
  { id = 'cor', name = "COR", type = 'integer', range = {-4,4} },
  { id = 'arc', name = "ARC", type = 'integer', range = {-4,4} },
  { id = 'ani', name = "ANI", type = 'integer', range = {-4,4} },
  { id = 'spd', name = "SPD", type = 'integer', range = {-4,4} },
